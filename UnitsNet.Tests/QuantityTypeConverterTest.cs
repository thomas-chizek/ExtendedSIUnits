...
namespace UnitsNet.Tests
{
    public class QuantityTypeConverterTest
    {
        ...
        {
            var converter = new QuantityTypeConverter<Area>(Area.Zero);
            ITypeDescriptorContext context = new TypeDescriptorContext("SomeMemberName", new Attribute[] { });
        ...
        {
            var converter = new QuantityTypeConverter<Volume>(Volume.Zero);
            ITypeDescriptorContext context = new TypeDescriptorContext("SomeMemberName", new Attribute[] { });
        ...
        {
            var converter = new QuantityTypeConverter<AreaMomentOfInertia>(AreaMomentOfInertia.Zero);
            ITypeDescriptorContext context = new TypeDescriptorContext("SomeMemberName", new Attribute[] { });
        ...
        {
            var converter = new QuantityTypeConverter<CoefficientOfThermalExpansion>(CoefficientOfThermalExpansion.Zero);
            ITypeDescriptorContext context = new TypeDescriptorContext("SomeMemberName", new Attribute[] { });
        ...
        {
            var converter = new QuantityTypeConverter<MassFlux>(MassFlux.Zero);
            ITypeDescriptorContext context = new TypeDescriptorContext("SomeMemberName", new Attribute[] { });
