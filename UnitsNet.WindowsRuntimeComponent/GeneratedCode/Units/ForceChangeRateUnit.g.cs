...
namespace UnitsNet.Units
{
    ...
    public enum ForceChangeRateUnit
    {
        ...
        ExanewtonPerMinute,
        ExanewtonPerSecond,
        FemtonewtonPerMinute,
        FemtonewtonPerSecond,
        GiganewtonPerMinute,
        GiganewtonPerSecond,
        HectonewtonPerMinute,
        HectonewtonPerSecond,
        KilonewtonPerMinute,
        KilonewtonPerSecond,
        MeganewtonPerMinute,
        MeganewtonPerSecond,
        MicronewtonPerMinute,
        MicronewtonPerSecond,
        MillinewtonPerMinute,
        ...
        PiconewtonPerMinute,
        PiconewtonPerSecond,
        QutranewtonPerMinute,
        QutranewtonPerSecond,
        TeranewtonPerMinute,
        TeranewtonPerSecond,
