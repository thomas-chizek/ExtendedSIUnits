...
namespace UnitsNet
{
    ...
    /// </remarks>
    public partial class Molarity : IQuantity<MolarityUnit>, IEquatable<Molarity>, IComparable, IComparable<Molarity>, IConvertible, IFormattable
    {
        /// <summary>
        ...
        static Molarity()
        {
            ...
            Info = new QuantityInfo<MolarityUnit>(QuantityType.Molarity,
                new UnitInfo<MolarityUnit>[] {
                    new UnitInfo<MolarityUnit>(MolarityUnit.CentimolesPerLiter, new BaseUnits(length: LengthUnit.Decimeter, amount: AmountOfSubstanceUnit.Mole)),
                    new UnitInfo<MolarityUnit>(MolarityUnit.DecimolesPerLiter, new BaseUnits(length: LengthUnit.Decimeter, amount: AmountOfSubstanceUnit.Mole)),
                    new UnitInfo<MolarityUnit>(MolarityUnit.MicromolesPerLiter, new BaseUnits(length: LengthUnit.Decimeter, amount: AmountOfSubstanceUnit.Mole)),
                    new UnitInfo<MolarityUnit>(MolarityUnit.MillimolesPerLiter, new BaseUnits(length: LengthUnit.Decimeter, amount: AmountOfSubstanceUnit.Mole)),
                    ...
                    new UnitInfo<MolarityUnit>(MolarityUnit.NanomolesPerLiter, new BaseUnits(length: LengthUnit.Decimeter, amount: AmountOfSubstanceUnit.Mole)),
                    new UnitInfo<MolarityUnit>(MolarityUnit.PicomolesPerLiter, new BaseUnits(length: LengthUnit.Decimeter, amount: AmountOfSubstanceUnit.Mole)),
                },
