...
namespace UnitsNet
{
    ...
    public partial struct Power : IQuantity<PowerUnit>, IEquatable<Power>, IComparable, IComparable<Power>, IConvertible, IFormattable
    {
        ...
        static Power()
        {
            ...
            Info = new QuantityInfo<PowerUnit>(QuantityType.Power,
                new UnitInfo<PowerUnit>[] {
                    new UnitInfo<PowerUnit>(PowerUnit.Attowatt, BaseUnits.Undefined),
                    ...
                    new UnitInfo<PowerUnit>(PowerUnit.Centiwatt, BaseUnits.Undefined),
                    ...
                    new UnitInfo<PowerUnit>(PowerUnit.Exawatt, BaseUnits.Undefined),
                    ...
                    new UnitInfo<PowerUnit>(PowerUnit.Hectowatt, BaseUnits.Undefined),
                    ...
                    new UnitInfo<PowerUnit>(PowerUnit.Qutrawatt, BaseUnits.Undefined),
                    new UnitInfo<PowerUnit>(PowerUnit.Terawatt, BaseUnits.Undefined),
                    new UnitInfo<PowerUnit>(PowerUnit.Vettawatt, BaseUnits.Undefined),
                    new UnitInfo<PowerUnit>(PowerUnit.Watt, BaseUnits.Undefined),
                    new UnitInfo<PowerUnit>(PowerUnit.Yoctowatt, BaseUnits.Undefined),
                    new UnitInfo<PowerUnit>(PowerUnit.Yottawatt, BaseUnits.Undefined),
                    new UnitInfo<PowerUnit>(PowerUnit.Zeptowatt, BaseUnits.Undefined),
                    new UnitInfo<PowerUnit>(PowerUnit.Zettawatt, BaseUnits.Undefined),
                },
        ...
        public Power(double numericValue, PowerUnit unit)
        {
        ...
        public Power(double numericValue, UnitSystem unitSystem)
        {
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Power FromAttowatts(QuantityValue attowatts)
        {
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Power FromCentiwatts(QuantityValue centiwatts)
        {
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Power FromExawatts(QuantityValue exawatts)
        {
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Power FromHectowatts(QuantityValue hectowatts)
        {
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Power FromQutrawatts(QuantityValue qutrawatts)
        {
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Power FromVettawatts(QuantityValue vettawatts)
        {
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Power FromYoctowatts(QuantityValue yoctowatts)
        {
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Power FromYottawatts(QuantityValue yottawatts)
        {
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Power FromZeptowatts(QuantityValue zeptowatts)
        {
        ...
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static Power FromZettawatts(QuantityValue zettawatts)
        {
