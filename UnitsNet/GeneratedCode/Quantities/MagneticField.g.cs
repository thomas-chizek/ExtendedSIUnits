...
namespace UnitsNet
{
    ...
    /// </remarks>
    public partial class MagneticField : IQuantity<MagneticFieldUnit>, IEquatable<MagneticField>, IComparable, IComparable<MagneticField>, IConvertible, IFormattable
    {
        /// <summary>
        ...
        static MagneticField()
        {
            ...
            Info = new QuantityInfo<MagneticFieldUnit>(QuantityType.MagneticField,
                new UnitInfo<MagneticFieldUnit>[] {
                    new UnitInfo<MagneticFieldUnit>(MagneticFieldUnit.Decatesla, BaseUnits.Undefined),
                    new UnitInfo<MagneticFieldUnit>(MagneticFieldUnit.Gigatesla, BaseUnits.Undefined),
                    new UnitInfo<MagneticFieldUnit>(MagneticFieldUnit.Kilotesla, BaseUnits.Undefined),
                    new UnitInfo<MagneticFieldUnit>(MagneticFieldUnit.Megatesla, BaseUnits.Undefined),
                    ...
                    new UnitInfo<MagneticFieldUnit>(MagneticFieldUnit.Teratesla, BaseUnits.Undefined),
        ...
        /// <summary>
        ///     Get MagneticField in Decateslas.
        /// </summary>
        public double Decateslas => As(MagneticFieldUnit.Decatesla);

        /// <summary>
        ///     Get MagneticField in Gigateslas.
        /// </summary>
        public double Gigateslas => As(MagneticFieldUnit.Gigatesla);

        /// <summary>
        ///     Get MagneticField in Kiloteslas.
        /// </summary>
        public double Kiloteslas => As(MagneticFieldUnit.Kilotesla);

        /// <summary>
        ///     Get MagneticField in Megateslas.
        /// </summary>
        public double Megateslas => As(MagneticFieldUnit.Megatesla);
        ...
        /// <summary>
        ///     Get MagneticField in Terateslas.
        /// </summary>
        public double Terateslas => As(MagneticFieldUnit.Teratesla);
        ...
        /// <summary>
        ///     Get MagneticField from Decateslas.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static MagneticField FromDecateslas(QuantityValue decateslas)
        {
            double value = (double) decateslas;
            return new MagneticField(value, MagneticFieldUnit.Decatesla);
        }
        /// <summary>
        ///     Get MagneticField from Gigateslas.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static MagneticField FromGigateslas(QuantityValue gigateslas)
        {
            double value = (double) gigateslas;
            return new MagneticField(value, MagneticFieldUnit.Gigatesla);
        }
        /// <summary>
        ///     Get MagneticField from Kiloteslas.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static MagneticField FromKiloteslas(QuantityValue kiloteslas)
        {
            double value = (double) kiloteslas;
            return new MagneticField(value, MagneticFieldUnit.Kilotesla);
        }
        /// <summary>
        ///     Get MagneticField from Megateslas.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static MagneticField FromMegateslas(QuantityValue megateslas)
        {
            double value = (double) megateslas;
            return new MagneticField(value, MagneticFieldUnit.Megatesla);
        }
        /// <summary>
        ...
        /// <summary>
        ///     Get MagneticField from Terateslas.
        /// </summary>
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        public static MagneticField FromTerateslas(QuantityValue terateslas)
        {
            double value = (double) terateslas;
            return new MagneticField(value, MagneticFieldUnit.Teratesla);
        }
        /// <summary>
        ...
        private double GetValueInBaseUnit()
        {
            switch(Unit)
            {
                case MagneticFieldUnit.Decatesla: return (_value) * 1e1d;
                case MagneticFieldUnit.Gigatesla: return (_value) * 1e9d;
                case MagneticFieldUnit.Kilotesla: return (_value) * 1e3d;
                case MagneticFieldUnit.Megatesla: return (_value) * 1e6d;
                ...
                case MagneticFieldUnit.Teratesla: return (_value) * 1e12d;
        ...
        private double GetValueAs(MagneticFieldUnit unit)
        {
            ...
            switch(unit)
            {
                case MagneticFieldUnit.Decatesla: return (baseUnitValue) / 1e1d;
                case MagneticFieldUnit.Gigatesla: return (baseUnitValue) / 1e9d;
                case MagneticFieldUnit.Kilotesla: return (baseUnitValue) / 1e3d;
                case MagneticFieldUnit.Megatesla: return (baseUnitValue) / 1e6d;
                ...
                case MagneticFieldUnit.Teratesla: return (baseUnitValue) / 1e12d;
