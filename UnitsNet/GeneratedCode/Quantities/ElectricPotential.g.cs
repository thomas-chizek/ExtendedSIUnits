...
namespace UnitsNet
{
    ...
    /// </summary>
    public partial class ElectricPotential : IQuantity<ElectricPotentialUnit>, IEquatable<ElectricPotential>, IComparable, IComparable<ElectricPotential>, IConvertible, IFormattable
    {
        /// <summary>
        ...
        static ElectricPotential()
        {
            ...
            Info = new QuantityInfo<ElectricPotentialUnit>(QuantityType.ElectricPotential,
                new UnitInfo<ElectricPotentialUnit>[] {
                    new UnitInfo<ElectricPotentialUnit>(ElectricPotentialUnit.Kilovolt, new BaseUnits(length: LengthUnit.Meter, mass: MassUnit.Kilogram, time: DurationUnit.Second, current: ElectricCurrentUnit.Ampere)),
                    new UnitInfo<ElectricPotentialUnit>(ElectricPotentialUnit.Megavolt, new BaseUnits(length: LengthUnit.Meter, mass: MassUnit.Kilogram, time: DurationUnit.Second, current: ElectricCurrentUnit.Ampere)),
                    new UnitInfo<ElectricPotentialUnit>(ElectricPotentialUnit.Microvolt, new BaseUnits(length: LengthUnit.Meter, mass: MassUnit.Kilogram, time: DurationUnit.Second, current: ElectricCurrentUnit.Ampere)),
                    new UnitInfo<ElectricPotentialUnit>(ElectricPotentialUnit.Millivolt, new BaseUnits(length: LengthUnit.Meter, mass: MassUnit.Kilogram, time: DurationUnit.Second, current: ElectricCurrentUnit.Ampere)),
        ...
        public ElectricPotential(double numericValue, ElectricPotentialUnit unit)
        {
        ...
        public ElectricPotential(double numericValue, UnitSystem unitSystem)
        {
