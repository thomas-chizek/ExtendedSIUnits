...
namespace UnitsNet
{
    ...
    /// </remarks>
    public partial class Capacitance : IQuantity<CapacitanceUnit>, IEquatable<Capacitance>, IComparable, IComparable<Capacitance>, IConvertible, IFormattable
    {
        /// <summary>
        ...
        static Capacitance()
        {
            ...
            Info = new QuantityInfo<CapacitanceUnit>(QuantityType.Capacitance,
                new UnitInfo<CapacitanceUnit>[] {
                    ...
                    new UnitInfo<CapacitanceUnit>(CapacitanceUnit.Kilofarad, new BaseUnits(length: LengthUnit.Meter, mass: MassUnit.Kilogram, time: DurationUnit.Second, current: ElectricCurrentUnit.Ampere)),
                    new UnitInfo<CapacitanceUnit>(CapacitanceUnit.Megafarad, new BaseUnits(length: LengthUnit.Meter, mass: MassUnit.Kilogram, time: DurationUnit.Second, current: ElectricCurrentUnit.Ampere)),
                    new UnitInfo<CapacitanceUnit>(CapacitanceUnit.Microfarad, new BaseUnits(length: LengthUnit.Meter, mass: MassUnit.Kilogram, time: DurationUnit.Second, current: ElectricCurrentUnit.Ampere)),
                    new UnitInfo<CapacitanceUnit>(CapacitanceUnit.Millifarad, new BaseUnits(length: LengthUnit.Meter, mass: MassUnit.Kilogram, time: DurationUnit.Second, current: ElectricCurrentUnit.Ampere)),
                    new UnitInfo<CapacitanceUnit>(CapacitanceUnit.Nanofarad, new BaseUnits(length: LengthUnit.Meter, mass: MassUnit.Kilogram, time: DurationUnit.Second, current: ElectricCurrentUnit.Ampere)),
                    new UnitInfo<CapacitanceUnit>(CapacitanceUnit.Picofarad, new BaseUnits(length: LengthUnit.Meter, mass: MassUnit.Kilogram, time: DurationUnit.Second, current: ElectricCurrentUnit.Ampere)),
                },
        ...
        public Capacitance(double numericValue, UnitSystem unitSystem)
        {
